...
| Method | Endpoint | Description |
| ------ | -------- | ----------- |
| `GET` | `/video/list` | List available video streams |
| `GET` | `/video/stream/*` | Stream video feed |
| `POST` | `/webrtc/signal` | WebRTC signaling endpoint |
...
| `GET` | `/sys/monitor/sse` | System monitor SSE stream |
