---
title: IaC Toolbelt
description: Infrastructure as Code toolbelt for rapid deployment of Constellation Overwatch C4ISR Data Plane on Linode
icon: Wrench
---

Vendor agnostic Infrastructure as Code (IaC) toolbelt for rapid deployment of Constellation Overwatch C4ISR Data Plane on Linode.

## About

The **IaC Toolbelt** is a specialized suite of automation tools designed to streamline the deployment of the Constellation Overwatch C4ISR Data Plane. By leveraging industry-standard Infrastructure as Code (IaC) principles, this toolbelt enables rapid, reproducible, and secure provisioning of cloud computing resources.
...
| `OVERWATCH_DATA_DIR` | `./data` | Root data directory (DB and NATS storage) |
