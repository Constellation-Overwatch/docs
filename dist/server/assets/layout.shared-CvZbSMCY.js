...
const defaultColor$1 = "#5865F2";
const SiDiscord = reactExports.forwardRef(function SiDiscord2({ title = "Discord", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
...
const SiGithub = reactExports.forwardRef(function SiGithub2({ title = "GitHub", color = "currentColor", size = 24, ...others }, ref) {
  if (color === "default") {
    color = defaultColor;
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
  ...
  return {
    nav: {
      title: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: "/images/c4-logo.png", alt: "Constellation Overwatch", className: "w-6 h-6" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold", children: "Constellation Overwatch" })
      ] }),
      transparentMode: "top"
    },
    links: [
      ...
      },
      {
        type: "icon",
        label: "Discord",
        icon: /* @__PURE__ */ jsxRuntimeExports.jsx(SiDiscord, {}),
        text: "Discord",
