import { m as map$2, f as flatten$1, d as min } from "./min-DV2E6Urc.js";
import { b as baseFlatten$1, l as baseUniq$1, d as baseIteratee$2, m as filter$1, r as reduce$1, n as forEach$2 } from "./_baseUniq-D8hqWjjG.js";
import { b7 as isEmpty$1 } from "./mermaid.core-CYQiQoE6.js";
...
var initializers = {
  info: /* @__PURE__ */ __name(async () => {
    const { createInfoServices: createInfoServices2 } = await Promise.resolve().then(() => infoNVLQJR56);
    const parser = createInfoServices2().Info.parser.LangiumParser;
    parsers.info = parser;
  }, "info"),
  packet: /* @__PURE__ */ __name(async () => {
    const { createPacketServices: createPacketServices2 } = await Promise.resolve().then(() => packetBFZMPI3H);
    const parser = createPacketServices2().Packet.parser.LangiumParser;
    parsers.packet = parser;
  }, "packet"),
  pie: /* @__PURE__ */ __name(async () => {
    const { createPieServices: createPieServices2 } = await Promise.resolve().then(() => pie7BOR55EZ);
    const parser = createPieServices2().Pie.parser.LangiumParser;
    parsers.pie = parser;
  }, "pie"),
  architecture: /* @__PURE__ */ __name(async () => {
    const { createArchitectureServices: createArchitectureServices2 } = await Promise.resolve().then(() => architectureU656AL7Q);
    const parser = createArchitectureServices2().Architecture.parser.LangiumParser;
    parsers.architecture = parser;
  }, "architecture"),
  gitGraph: /* @__PURE__ */ __name(async () => {
    const { createGitGraphServices: createGitGraphServices2 } = await Promise.resolve().then(() => gitGraphF6HP7TQM);
    const parser = createGitGraphServices2().GitGraph.parser.LangiumParser;
    parsers.gitGraph = parser;
  }, "gitGraph"),
  radar: /* @__PURE__ */ __name(async () => {
    const { createRadarServices: createRadarServices2 } = await Promise.resolve().then(() => radarNHE76QYJ);
    const parser = createRadarServices2().Radar.parser.LangiumParser;
    parsers.radar = parser;
  }, "radar"),
  treemap: /* @__PURE__ */ __name(async () => {
    const { createTreemapServices: createTreemapServices2 } = await Promise.resolve().then(() => treemapKMMF4GRG);
